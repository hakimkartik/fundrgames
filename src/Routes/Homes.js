      ...
      <>
        ...
        <div className="row justify-content-center">
          <Carousel id="popular-game-carousel" className="carousel-size">
            <Carousel.Item className="carousel-img-wrapper">
              <img
        ...
        <div className="row mt-4">
          <div className="col-6">
            <div className="row recommended-game-box">
              ...
              <div className="col-6">
                <h5 className="text-uppercase recommended-name">INSCRYPTION</h5>
                <p className="lilac-fill">
                  A card game with a twist. The gamer will have to use a strategy
                  and sacrifice resources to challenge the next opponent.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="row recommended-game-box">
              ...
              <div className="col-6">
                ...
                <p className="lilac-fill">
                  ...
                  shelter, find food, and craft tools to construct the universe they
                  want to live in.
                </p>
              </div>
            </div>
        ...
        <div className="row mt-4">
          ...
          <div className="col-6">
            <div className="row recommended-game-box">
              ...
              <div className="col-6">
                <h5 className="text-uppercase recommended-name">DISCO ELYSIUM</h5>
                <p className="lilac-fill">
                  A detective looses his memory and has to solve a macabre murder. A
                  fight with his own psyche will bring him new challenges and new
                  suspects.
                </p>
              </div>
            </div>
