        ...
        <div className="row">
            ...
            <div className="col-6">
                <div className="container-left d-flex flex-wrap justify-content-center text-center mx-auto">
                    <h2 className="col-12 d-flex align-items-center justify-content-center">Sign up for an account</h2>
                    <div className="col-6 d-flex flex-wrap justify-content-center">
                        <div className="type-icon">
                            <img src={game} alt="gamer icon" className="type-img"/>
                        </div>
                        <div className="col-12">
                            <Link className="btn btn-primary w-75 btn-type" to={"/gameregister"}>I am a gamer</Link>
                        </div>
                    ...
                    <div className="col-6 d-flex flex-wrap justify-content-center">
                        ...
                        <div className="col-12">
                            <Link className="btn btn-primary w-75 btn-type" to={"/devregister"}>I am a developer</Link>
                        </div>
                        <div className="w-100 d-flex justify-content-center">
