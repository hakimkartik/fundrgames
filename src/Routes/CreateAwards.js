...
<div className="row justify-content-evenly">
    <div className="col text-center">
        ...
        <p className="fw-lighter fst-italic">As backers support you, you can also support them</p>
    </div>
</div>
...
<p className="text fw-lighter">Set the minimum amount they have to pledge and the reward that will be given</p>
<br/>
...
<div className="input-group mb-5">
  ...
  <input type="text" className="form-control" aria-label="Amount (to the nearest dollar)" placeholder="$1 or more"/>
  <span className="input-group-text">.00</span>
</div>

<div className="form-floating mb-5">
  <textarea className="form-control rewards-height" placeholder="Description" id="floatingTextarea2"></textarea>
...
<div className="row d-grid gap-2 mb-5">
  <button className="btn btn-primary" type="submit" onClick={onSubmitHandler}>Next: Payments</button>
</div>
