                    ...
                    <div className="card p-2">
                        <div className="row mt-3">
                            <div className="col-2 d-flex justify-content-end">
                                <img className="card-img-left author-avatar" alt="Susy Jane" src="https://steinhardt.nyu.edu/sites/default/files/styles/nyu_profile_image/public/2021-03/music_edtheatre_faculty_SuzyJaneHunt.jpg?h=2f170955&itok=e8hKw3uU"/>
                            </div>
